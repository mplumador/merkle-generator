...
export default class BalanceTree {
  ...
  static verifyProof(index, account, poolId, totalLPTokenAmount, totalTICAmount, proof, root) {
    let pair = BalanceTree.toNode(index, account, poolId, totalLPTokenAmount, totalTICAmount);
